...
##
from screens import scrolltoolbar, bottomnavigation,spinners, dataloader, selectionlist, piechart, imageviewer, onboarding,progressbutton
kv='''
...
class DemoApp(MDApp):
    ...
    screens=[
        ...
        'Onboarding','ProgressButton','ScrollToolbar',
    ]
