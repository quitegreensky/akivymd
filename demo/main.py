...
##
from screens import bottomnavigation,spinners, dataloader, selectionlist, piechart, imageviewer, onboarding,progressbutton,silverappbar
kv='''
...
class DemoApp(MDApp):
    ...
    screens=[
        ...
        'Onboarding','ProgressButton','SilverAppbar',
    ]
